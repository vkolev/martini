...
Martini е мощен пакет за бързо писане на модулни уеб приложения/услуги с програмния език Go.
...
* [Български](translations/README_bg_BG.md)

## Да започнем

След инсталиране на Go и задаване на вашия [GOPATH](http://golang.org/doc/code.html#GOPATH), създадете вашия пръв `.go` файл. Ще го наречем `server.go`.
...
След това инсталирайте Martini пакета (необходим е **go 1.1** или по-нова версия):
~~~
go get github.com/go-martini/martini
~~~

След това стартирайте вашия сървър:
~~~
go run server.go
~~~

Вече ще имате работещ Martini уеб-сървър на `localhost:3000`.

## Получаване на помощ

Присъединете се към [Пощенския списък](https://groups.google.com/forum/#!forum/martini-go)

Гледайте [Примерно видео](http://martini.codegangsta.io/#demo)

Задавайте въпроси в Stackoverflow използвайки [martini етикет](http://stackoverflow.com/questions/tagged/martini)

GoDoc [документация](http://godoc.org/github.com/go-martini/martini)


## Особености
* Екстремно лесен за ползване.
* Не натрапчив дизайн.
* Играе добре с други Golang пакети.
* Супер съчетаване на пътища и маршрутизация.
* Модулярен дизайн - Лесно добавяне на функционалност, лесно премахване на неща.
* Много добри изпълнители/мидълуер за използване.
* Страхотен 'out of the box' набор от функции.
* **Напълно съвместим с [http.HandlerFunc](http://godoc.org/net/http#HandlerFunc) интерфейсът.**
* Подаване на документи по подразбиране (н.пр., за подаване на AngularJS приложения в режим HTML5).
